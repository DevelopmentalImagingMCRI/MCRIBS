...
run tissue-priors-mcribs.sh     $subj $atlasname $threads
# registration using gm posterior + image
run register-multi-atlas-using-gm-posteriors-mcribs.sh $subj $threads
# structural segmentation
run labels-multi-atlas-mcribs.sh   $subj
exit;
