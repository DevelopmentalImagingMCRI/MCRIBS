...
do
    ...
    mri_surf2surf --cortex --srcsubject fsaverage --trgsubject fs_LR_164k --hemi $HEMI --sval-annot ${SUBJ}.$ATLAS.tmp.annot --o $SUBJECTS_DIR/$1/label/$HEMI.$ATLAS.fslr164k.annot --srcsurfreg sphere.reg.fslr164k --trgsurfreg sphere
